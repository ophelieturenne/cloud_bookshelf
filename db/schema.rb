...
ActiveRecord::Schema[7.1].define(version: 2024_11_23_183944) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.index ["qr_code"], name: "index_books_on_qr_code"
  ...
  create_table "libraries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["unique_id"], name: "index_libraries_on_unique_id"
  end
