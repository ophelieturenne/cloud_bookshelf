Rails.application.routes.draw do
  ...
  devise_for :users
  # This generates all the necessary routes for user authentication using Devise,
  # including sign-up, login, logout, password recovery, etc.

  # Root route for the homepage
  root to: "pages#home"
  # Defines the root path of the application to display the homepage.
  # The `home` action in the `PagesController` will be called when users visit `/`.
